...
/**
 * Component to display a UI with a summary of all bond assets and a list of them
 */
@Component({
  selector: 'app-bonds',
...
export class BondsComponent extends GlobalAssetsComponent implements OnInit {
  ...
  ngOnInit() {
    this.pageTitle = 'Bonds';
    this.assetTypes = AssetType.Bond;
    super.ngOnInit();
  }
}
