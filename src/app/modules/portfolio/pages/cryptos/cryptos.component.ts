...
/**
 * Component to display a UI with a summary of all cryptocurrency assets and a list of them
 */
@Component({
  selector: 'app-crypto',
...
export class CryptosComponent extends GlobalAssetsComponent implements OnInit {
  ...
  ngOnInit() {
    this.pageTitle = 'Cryptocurrencies';
    this.assetTypes = AssetType.Cryptocurrency;
    super.ngOnInit();
  }
}
